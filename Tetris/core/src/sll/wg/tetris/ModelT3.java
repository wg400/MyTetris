...
public class ModelT3 extends Model  {
	// LÐÍ
	public ModelT3(TetrisModel[][] tetrisModels) {
		super(tetrisModels);
	}
	...
	public void moveDown() {
		if (this.i<18) {
			this.i++ ;
			if (tetrisModels[i][j-1].isLock || tetrisModels[i][j+1].isLock || tetrisModels[i+1][j].isLock) {
				this.i-- ;
				lock() ;
			} else {
				this.i-- ;
